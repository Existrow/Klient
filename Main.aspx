    ...
    <form id="Main" runat="server">
        <div id="Menu">
            <asp:Panel ID="AuthPanel" runat="server">
                ...
                <asp:Button ID="AuthButton" runat="server" Text="Войти" OnClick="AuthButton_Click"/>
                <asp:Button ID="RegButton" runat="server" Text="Зарегистрироваться" OnClick="RegButton_Click"/>
            </asp:Panel>
            <asp:Button ID="LogutButton" runat="server" Text="---ВЫЙТИ---" OnClick="LogutButton_Click"/>
